...
-Limit
   O LIMIT é uma cláusala do SQL que serve exatamente para o que o nome diz: limitar a quantidade de linhas que o banco de dados vai te devolver no resultado de uma consulta com o SELECT.
